...
public class ItemServlet extends HttpServlet implements Servlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
    	...
    	bids.add(new Bid("427","nobody138","GOD BLESS AMERICA, FROM SOUTH, MS","USA","Dec-04-01 23:20:07","$12.99"));
    	bids.add(new Bid("1","danielhb2000","Huntington Beach, Ca.","USA","Dec-06-01 02:00:07","$15.99"));
    	
    	request.setAttribute("item_id", item_id);
    	request.setAttribute("name", name);
    	request.setAttribute("seller_user_id", seller_user_id);
    	...
    	request.setAttribute("num_bids", num_bids);
    	request.setAttribute("description", description);
    	request.setAttribute("buy_price", buy_price);
    	request.setAttribute("latitude", latitude);
    	request.setAttribute("longitude", longitude);
    	request.setAttribute("location_text", location_text);
